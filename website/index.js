window.onload = function () {
	...
	if (/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) ||
		...
		document.getElementById("viewer").classList.add("mobile");
		document.getElementById("header-title").classList.add("mobile");
		document.getElementById("header-search").classList.add("mobile");
		document.getElementById("header-terms").classList.add("mobile");
		document.getElementById("header-acknowledgements").classList.add("mobile");
		document.getElementById("top-button").classList.add("mobile");
	}
